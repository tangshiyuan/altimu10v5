...
##lstm_model = load_model('gait_lstm.52-0.27163-0.41092.h5') # sem1
lstm_model = load_model('gait_lstm.150-0.44406-0.48743') # sem2

lstm_model.summary()

# load scaler
##predict_scaler = joblib.load('scaler.save') # sem1
predict_scaler = joblib.load('scaler_sem2.save') # sem2
